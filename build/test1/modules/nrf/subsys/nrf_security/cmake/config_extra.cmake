...
set(NRFXLIB_DIR          D:/WORK_NRF/ncs/v3.3.0/nrfxlib            CACHE STRING "nrfxlib folder")
set(NRF_SECURITY_ROOT    D:/WORK_NRF/ncs/v3.3.0/nrf/subsys/nrf_security          CACHE STRING "nrf_security root folder")
set(OBERON_PSA_CORE_PATH D:/WORK_NRF/ncs/v3.3.0/modules/crypto/oberon-psa-crypto  CACHE STRING "oberon-psa-core folder")
set(ARM_MBEDTLS_PATH     D:/WORK_NRF/ncs/v3.3.0/modules/crypto/mbedtls            CACHE STRING "Mbed TLS folder")
set(NRF_DIR              D:/WORK_NRF/ncs/v3.3.0/nrf                              CACHE STRING "NRF folder")
set(TFM_BOARDS_NRF_DIR   D:/WORK_NRF/ncs/v3.3.0/nrf/modules/trusted-firmware-m/tfm_boards CACHE STRING "tfm_boards folder")
...
set(PSA_CRYPTO_CONFIG_INTERFACE_PATH    D:/WORK_NRF/test_kbd/test1/build/test1/generated/interface_nrf_security_psa CACHE STRING "Path used for generated PSA crypto configuratiosn for the interface")
set(PSA_CRYPTO_CONFIG_LIBRARY_PATH      D:/WORK_NRF/test_kbd/test1/build/test1/generated/library_nrf_security_psa CACHE STRING "Path used for generated PSA crypto for library builds")
