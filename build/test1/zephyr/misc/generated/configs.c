...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HIDS_ATTR_MAX, 21);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HIDS_INPUT_REP_MAX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HIDS_OUTPUT_REP_MAX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HIDS_FEATURE_REP_MAX, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_TX_COUNT, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PMICRO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PMICRO_NRF52840, 1);
